...
//zero out
var losses = 0;var skip = 0;var winStreak = 0;
var lostGames = 0;var waitXgames = 0;var CO = 0;
result = 'No results yet.. ';var lossStreak = 0;
statsAllWins = 0;statsAllLosses = 0;
...
style.type = 'text/css';
style.innerHTML = '';
//style.innerHTML += '.users-playing tr[data-reactid*="0"]{display:none}'; //hide names not on the list
var arrayLength = usersArray.length;
for (var i = 0; i < arrayLength; i++) {
    style.innerHTML += '.users-playing tr[data-reactid*="';
